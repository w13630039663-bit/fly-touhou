...
const DEFAULTS = {
  // 中心螺旋
  arms: 6,              // [实测] 螺旋臂数
  armSpacing: 48,       // [视觉调] 相邻两圈的半径差 (px)
  maxRadius: 304,       // [实测] 螺旋最大半径 (px)
  rotationSpeed: 120,   // [推测] 整体旋转 (°/s)
  radialFlow: 81,       // [推测] 珠子沿外喷射速度 (px/s) = maxRadius / cycleTime
  beadsPerTurn: 28,     // 每圈的珠子密度
...
const CYCLE_TIME = 3.74;   // [实测] 符卡周期 (s) —— 由 maxRadius/radialFlow 反推保持一致
