...
export const translations = {
  zh: {
    ...
    train: {
      ...
      tbl_baseline: '评估基线 (20 个独立测试种子均值)',
      tbl_survival: '存活时间 (秒)',
      tbl_frames: '平均存活帧数',
      tbl_significance: '口径说明',
      ...
      row_silenced_desc: '同一解码器、同一输入，仅脑活动归零 ⇒ 成绩塌到与"完全不动"逐位相同 ⇒ 行为确实来自这颗脑',
  ...
  en: {
    ...
    train: {
      ...
      tbl_baseline: 'Evaluation Baseline (20 Independent Test Seeds)',
      tbl_survival: 'Survival Time (s)',
      tbl_frames: 'Frames Survived',
      tbl_significance: 'Notes',
      ...
      row_silenced_desc: 'Same decoder, same input, only brain activity zeroed ⇒ performance collapses to bit-identical with "not moving at all" ⇒ the behaviour really comes from this brain',
